...
def dibujar_tabla_suma(scrollable_frame, botones_frame, canvas):
    a_text = simpledialog.askstring("Suma", "Primer sumando:", parent=scrollable_frame)
    b_text = simpledialog.askstring("Suma", "Segundo sumando:", parent=scrollable_frame)
    ...
    max_ent, max_dec, show_comma = _compute_widths_for_two_numbers(a_ent, a_dec, a_has_dec, b_ent, b_dec, b_has_dec)
    ...
    # Fila 1: a
    _place_number_into_entries(entries, fila=1, entera=a_ent, decimal=a_dec,
    ...
    _place_number_into_entries(entries, fila=2, entera=b_ent, decimal=b_dec,
                               max_entera=max_ent, max_decimal=max_dec,
...
def dibujar_tabla_resta(scrollable_frame, botones_frame, canvas):
    a_text = simpledialog.askstring("Resta", "Minuendo:", parent=scrollable_frame)
    b_text = simpledialog.askstring("Resta", "Sustraendo:", parent=scrollable_frame)
    if a_text is None or b_text is None:
        return
